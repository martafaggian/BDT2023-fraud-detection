'''
The purpose of this code is to define a data class Bank that represents a bank and provides
methods for converting the bank object to a dictionary or JSON string, submitting the object 
to a broker, and obtaining a query dictionary template for retrieving bank data. 
...
query_dict = Bank.get_query_dict(auto_id=True)
print(query_dict)
'''
